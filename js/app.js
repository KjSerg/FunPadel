...
function getEleHTML(html, text) {
  return "\n    <span class=\"title-text-main\">".concat(html, "</span>\n    <span class=\"title-text-bg\">").concat(text, "</span>\n    ");
}
...
/* harmony import */ var _accardion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_accardion */ "./resources/js/components/_accardion.js");
/* harmony import */ var _number_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_number-input */ "./resources/js/components/_number-input.js");
/* harmony import */ var _parallax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_parallax */ "./resources/js/components/_parallax.js");
/* harmony import */ var _$_title__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./$.title */ "./resources/js/components/$.title.js");
/* harmony import */ var _$_title__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_$_title__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_helpers */ "./resources/js/components/_helpers.js");
/* harmony import */ var _show_password__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_show-password */ "./resources/js/components/_show-password.js");
/* harmony import */ var _selectrickInit__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_selectrickInit */ "./resources/js/components/_selectrickInit.js");
...
/* harmony import */ var _togglers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./_togglers */ "./resources/js/components/_togglers.js");
/* harmony import */ var _credit_card__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./_credit-card */ "./resources/js/components/_credit-card.js");
/* harmony import */ var _fancybox_init__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./fancybox-init */ "./resources/js/components/fancybox-init.js");
  ...
  return _createClass(Application, [{
    ...
    value: function initComponents() {
      ...
      $doc.ready(function () {
        ...
        (0,_accardion__WEBPACK_IMPORTED_MODULE_1__.accordion)();
        (0,_number_input__WEBPACK_IMPORTED_MODULE_2__.numberInput)();
        (0,_show_password__WEBPACK_IMPORTED_MODULE_6__.showPassword)();
        t.setBrowserDataName();
        (0,_selectrickInit__WEBPACK_IMPORTED_MODULE_7__.selectrickInit)();
        (0,_togglers__WEBPACK_IMPORTED_MODULE_11__.toggler)();
        (0,_credit_card__WEBPACK_IMPORTED_MODULE_12__.creditCart)();
        (0,_fancybox_init__WEBPACK_IMPORTED_MODULE_13__.fancyboxInit)();
      });
    }
  }, {
    key: "simpleBarInit",
    value: function simpleBarInit() {
      window.ResizeObserver = resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_10__["default"];
      var simpleBarContainers = document.querySelectorAll('.scrollable-content');
      simpleBarContainers.forEach(function (simpleBarContainer) {
        var simpleBarInstance = new simplebar__WEBPACK_IMPORTED_MODULE_8__["default"](simpleBarContainer);
        if (simpleBarContainer.classList.contains('table-wrapper')) {
          var thead = simpleBarContainer.querySelector('thead');
          var tableHeader = simpleBarContainer.querySelector('.evolution-table-head');
          if (thead) {
            var diffTranslateY = 0;
            if (tableHeader) {
            ...
            scrollElement.addEventListener('scroll', function () {
              ...
              var translateY = scrollTop === 0 ? scrollTop : scrollTop - 2;
              if (diffTranslateY) {
                translateY = scrollTop === 0 ? translateY : translateY - diffTranslateY;
              }
              thead.style.transform = "translateY(".concat(translateY, "px)");
              if (scrollTop > 20) {
      ...
      $doc.ready(function () {
        $doc.find('.section').each(function () {
          ...
          if ($elements.length > 0) {
            (0,_parallax__WEBPACK_IMPORTED_MODULE_3__._parallax)({
    ...
    key: "setBrowserDataName",
    value: function setBrowserDataName() {
      var t = this;
      var $body = t.$body;
      var name = (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.detectBrowser)();
      $body.attr('data-browser', name).addClass(name);
      if (_helpers__WEBPACK_IMPORTED_MODULE_5__.isMobile) $body.attr('data-mobile', 'mobile');
    }
  }]);
}();
...
/***/ "./resources/js/components/_credit-card.js":
/*!*************************************************!*\
  !*** ./resources/js/components/_credit-card.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   creditCart: () => (/* binding */ creditCart)
/* harmony export */ });
var creditCart = function creditCart() {
  var doc = document;
...
/***/ "./resources/js/components/_parallax.js":
/*!**********************************************!*\
  !*** ./resources/js/components/_parallax.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _parallax: () => (/* binding */ _parallax)
/* harmony export */ });
...
var _parallax = function _parallax() {
  ...
  if (!_helpers__WEBPACK_IMPORTED_MODULE_0__.isMobile) {
    var depthCoefficient = Number((0,_helpers__WEBPACK_IMPORTED_MODULE_0__.randomIntFromInterval)(10, 60));
    var layers = wrapper.querySelectorAll(selector);
    wrapper.addEventListener("mousemove", function (e) {
      var x = e.clientX / window.innerWidth - 0.5;
      var y = e.clientY / window.innerHeight - 0.5;
      layers.forEach(function (layer, index) {
        depthCoefficient = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.isEven)(index) ? depthCoefficient - (index + 1) : depthCoefficient + (index + 1);
        var depth = (index + 1) * depthCoefficient / 10;
        var xOffset = x * depth;
        var yOffset = y * depth;
        xOffset = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.isEven)(index) ? (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.invertNumber)(xOffset) : xOffset;
        yOffset = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.isEven)(index) ? (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.invertNumber)(yOffset) : yOffset;
        layer.style.transform = "translate(".concat(xOffset, "px, ").concat(yOffset, "px)");
      });
    });
  }
};
...
/***/ "./resources/js/components/_selectrickInit.js":
/*!****************************************************!*\
  !*** ./resources/js/components/_selectrickInit.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/_show-password.js":
/*!***************************************************!*\
  !*** ./resources/js/components/_show-password.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/_togglers.js":
/*!**********************************************!*\
  !*** ./resources/js/components/_togglers.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
